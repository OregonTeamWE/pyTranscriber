...
class Ui_window(object):
    ...
    def retranslateUi(self, window):
        ...
        self.bSelectMedia.setText(_translate("window", "選擇文件"))
        self.bConvert.setText(_translate("window", "轉譯音頻 / 生成字幕"))
        self.bOpenOutputFolder.setText(_translate("window", "打開導出目錄"))
        self.bSelectOutputFolder.setText(_translate("window", "選擇導出目錄"))
        self.groupBox.setTitle(_translate("window", "&轉譯音頻 / 生成字幕文件清單"))
        self.bRemoveFile.setText(_translate("window", "移除文件"))
        self.bCancel.setText(_translate("window", "取消"))
        self.chbxOpenOutputFilesAuto.setText(_translate("window", "完成後自動打開導出目錄"))
        self.labelSelectLang.setText(_translate("window", "選擇音頻語言:"))
