...
class Ui_window(object):
    ...
    def retranslateUi(self, window):
        ...
        self.bConvert.setText(_translate("window", "转译音频 / 生成字幕"))
        self.bOpenOutputFolder.setText(_translate("window", "打开导出文件夹"))
        self.bSelectOutputFolder.setText(_translate("window", "导出位置"))
        self.groupBox.setTitle(_translate("window", "&转译 / 生成字幕文件列表"))
